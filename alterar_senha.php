...
<body class="fundo-site">
        ...
        <div class="alterarcss">
            <form class="formulario" method="post" action="">
                ...
                <div class="input-container">
                    <input id="nome" name="senha_nova" class="input" type="text" placeholder="" required />
                    <div class="legenda-p"></div>
                    <label for="nome" class="label icon icon-user-1"> Nova senha:</label>
                </div>
                <!-- Senha atual-->
                <div class="input-container">
    ...
    if(isset($_POST['senha_nova'])){
        ...
        if($senha == $senha2){
            ...
            if($resultado){
                print "<script>alert('Sua senha de Usuário foi alterada')</script>";
            }
        }
    }
    ?>
