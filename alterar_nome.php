...
<body class="fundo-site">
        ...
        <div class="alterarcss">
            <form class="formulario" method="post" action="">
                ...
                <div class="input-container">
                    <input id="nome" name="novo_nome" class="input" type="text" placeholder="" required />
                    <div class="legenda-p"></div>
                    <label for="nome" class="label icon icon-user-1"> Novo nome:</label>
                </div>
                <!-- Senha -->
                <div class="input-container">
    ...
    if(isset($_POST['novo_nome'])){
        ...
        if($senha == $senha2){
            ...
            if($resultado){
                print "<script>alert('Nome de Usuário alterado para $novo_nome')</script>";
            }
        }
    }
    ?>
