...
<body class="fundo-site">
    ...
    <div class="princ-div">
        <div id="carouselExampleIndicators" class="carousel slide banner" data-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img class="d-block w-100" src="img/banners/1.png" alt="Primeiro Slide">
                </div>
                <div class="carousel-item">
                    <img class="d-block w-100" src="img/banners/2.png" alt="Segundo Slide">
                </div>
                <div class="carousel-item">
                    <img class="d-block w-100" src="img/banners/3.png" alt="Terceiro Slide">
                </div>
            </div>
        ...
        <div class="cinza" style="margin-left: 60px;">
            <h3 class="texto-estilo1">Prod<span class="texto-estilo2">utos</span></h3>
        </div>
        <hr color="black">
        <!-- Primeira fileira -->
        <div class="primeira-fileira"><br>
            <h2 style="color:white; text-align:center; margin-left: 60px;">Cadeira Gamer</h2><br>
            <div class="produtos row">
                <div class="produto1 prod-cel col-md-5 col-lg-2 col-sm-10 col-xs-10">
                ...
                <div class="produto1 prod-cel col-md-5 col-lg-2 col-sm-10 col-xs-10">
                    ...
                    <p style="color:white;" class="mt-3">
                        <a href="produtos/produto4.php" class="">Cadeira Gamer ELG Homem Aranha<br><br>
                            R$ 1000,00
                        </a><br><br>
                    <form method="get" action="">
        ...
        <div class="segunda-fileira"><br>
            <h2 style="color:white; text-align:center; margin-left: 60px;">Headsets</h2><br>
            <div class="produtos row">
                <div class="produto1 prod-cel col-md-5 col-lg-2 col-sm-10 col-xs-10">
                    <img src="img/headsets/fone1.png" class="img-produto mt-2 img-fluid" alt="Cadeira Gamer"><br>
                    <p style="color:white;" class="mt-3">
                        <a href="produtos/produto5.php" class="">Microsoft Modern Wireless Headset<br><br>
                            R$ 119,90
                        </a><br><br>
                    <form method="get" action="">
                ...
                <div class="produto1 prod-cel col-md-5 col-lg-2 col-sm-10 col-xs-10">
                    ...
                    <p style="color:white;" class="mt-3">
                        <a href="produtos/produto7.php" class="">Headset Gamer Redragon Zeus X<br><br>
                            R$ 79,90
                        </a><br><br>
                    <form method="get" action="">
        ...
        <div class="terceira-fileira"><br>
            <h2 style="color:white; text-align:center; margin-left: 60px;">Mouses</h2>br
            <div class="produtos row">
                <div class="produto1 prod-cel col-md-5 col-lg-2 col-sm-10 col-xs-10">
                ...
                <div class="produto1 prod-cel col-md-5 col-lg-2 col-sm-10 col-xs-10 col-xs-12 ">
        ...
        ?>
        <br><br><br><br><br>
        <div class="rdp" style="margin-left: 60px;">
        <?php 
        include('rodape.php');
        ?>
        </div>
